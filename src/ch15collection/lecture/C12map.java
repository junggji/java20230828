...
public class C12map {
    public static void main(String[] args) {
        // Map : key, value 쌍(entry)를 저장 -->(dictionary)
        // key가 중복된 entry 가 있을 순 없다.

        Map<String, String> map = new HashMap<>();

        // put : entry 추가 메소드  --> 없으면 추가, 있으면 교체 메소드
        ...
        System.out.println("map.get(\"student2\") = " + map.get("student2")); // 없는 값은 null
