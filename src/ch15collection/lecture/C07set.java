...
public class C07set {
    public static void main(String[] args) {
        ...
        Set<String> set1 = new HashSet<>(); // 인터페이스라서 Set으로 못만든다.
        ...
        // size : 원소의 갯수
        System.out.println(set1.size()); // 3 -> 중복 허용 X

        // contains : 있는지 확인
        System.out.println(set1.contains("java")); // Object equals method -> Api확인
...
//        set2.add("java"); --> of객체라서 수정불가~~

        // 전체탐색 --> index 없음(get(0) 불가능)
        // 향상된 for
